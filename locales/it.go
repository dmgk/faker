...
var It = map[string]interface{}{
	"company": map[string]interface{}{
		...
		"name": []string{
			"#{Name.last_name} #{suffix}", "#{Name.last_name}-#{Name.last_name} #{suffix}", "#{Name.last_name}, #{Name.last_name} e #{Name.last_name} #{suffix}",
		},
		"suffix": []string{
	...
	"name": map[string]interface{}{
		...
		"suffix": []string{},
		"name": []string{
			"#{prefix} #{first_name} #{last_name}", "#{first_name} #{last_name}", "#{first_name} #{last_name}", "#{first_name} #{last_name}", "#{first_name} #{last_name}", "#{first_name} #{last_name}",
		},
	},
	...
	"address": map[string]interface{}{
		...
		"street_address": []string{
			"#{street_name} #{building_number}", "#{street_name} #{building_number}, #{secondary_address}",
		},
		"city_suffix": []string{
		...
		"street_name": []string{
			"#{street_suffix} #{Name.first_name}", "#{street_suffix} #{Name.last_name}",
		},
